              ...
              <div className="slot-list-carditems">
                <div class="slot-list-card">
                  ...
                  <div className="slotlist-rule">
                    ...
                    >
                      <Box sx={style} className="slot-list-modal_box">
                        <Typography
                  ...
                  <div className="slot-list-reg-section">
                    ...
                    <Link to={"/tournamentlist"}>slot list</Link>
                  </div>
                </div>
              </div>
              <div className="slot-list-carditems">
                        ...
                        <Box sx={style} className="slot-list-modal_box">
                          ...
                          >
                            <ul>
                              ...
                              <li>
                                If you are unable to join the custom tournament
                                created on the Call of Duty platform by the
                                start time, the joining fee will not be refunded
                              </li>
                              <li>
                                If you join the tournament on the Call of Duty
                                platform without joining the contest on Gamerji,
                              ...
                              <li>
                                Upload your Rank screenshot in the GamerJi App
                                within 30 mins after completion of the game to
                                get winnings.
                              </li>
                              <li>
                                Once you join the custom room on the Call of
                                Duty platform, position your player in the
                                column given to you. If you are found in any
                                other column, you might get kicked out
                              </li>
                              <li>
                                Teaming and/or griefing can get you kicked out
                                of the tournament. Admin’s decision will be
                                final in such cases and no refunds will be given{" "}
                              </li>
                            </ul>
                            <br />
                          </Typography>
