...
function ScrimsReg() {
  ...
  async function submitData(data) {
    let url = `https://gm4-server.herokuapp.com/api/user/scrim/registration/${id}/${localStorage.getItem('id')}`
    const options = {
      method: "POST",
      url: url,
      headers: {
    ...
    try {
      ...
      alert("Srims Registration Successfully")
      setSlot("")
      reset();
    } catch (error) {
            ...
            <fieldset className="uk-fieldset uk-grid-small" uk-grid>
              ...
              <FormControl sx={{ m: 1, minWidth: 200, }}>
                ...
                >
                  ...
                  <MenuItem value="Slot 1" id="scri__drop">Slot 1</MenuItem>
...
function ScrimsReg() {
  ...
  async function submitData(data) {
    ...
    try {
      const response = await axios(options);
      alert("Srims Added Successfully")
      setSlot("")
    } catch (error) {
      alert(error.response.data.error)
    } 
