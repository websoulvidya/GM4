  ...
  return(
    ...
    <div class="tour-card">
      ...
      <div className='tour-progress-bar'>
        <progress value={val.teamLimit} max="100">

        </progress>
  
        <p className='tourprogressbar-left-text'>{val.teamLimit} Joined</p>
        <p className='tourprogressbar-right-text'>{maxValue - (val.teamLimit)}   Spot left</p>
      </div>
